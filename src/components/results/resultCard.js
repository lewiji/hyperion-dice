...
function ResultCard({body, reducer, ...props}) {
    return <>
        <motion.div className={`p-1.5 bg-gradient-to-tr from-gray-900 via-indigo-900 to-indigo-800 rounded-lg my-4 overflow-hidden`}
            ...
            <p className={"text-sm font-semibold ml-1 bg-purple-500 bg-opacity-40 w-min px-2 rounded shadow-sm text-shadow-sm"}>{props.v.name}</p>
            ...
            <p className={"text-center p-1 bg-black bg-opacity-60 rounded-lg"}>
